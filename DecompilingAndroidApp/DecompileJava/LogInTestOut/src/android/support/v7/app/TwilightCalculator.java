...
class TwilightCalculator
{
    ...
    {
        float f = (float)(l - 0xdc6d62da00L) / 8.64E+007F;
        float f1 = 6.24006F + 0.01720197F * f;
        double d2 = 1.796593063D + ((double)f1 + 0.033419601619243622D * Math.sin(f1) + 0.00034906598739326D * Math.sin(2.0F * f1) + 5.2360001063789241E-006D * Math.sin(3F * f1)) + 3.1415926535897931D;
        d1 = -d1 / 360D;
