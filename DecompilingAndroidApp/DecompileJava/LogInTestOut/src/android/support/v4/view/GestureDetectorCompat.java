...
_L9:
            if(f * VelocityTrackerCompat.getXVelocity(mVelocityTracker, i2 = motionevent.getPointerId(j)) + f1 * VelocityTrackerCompat.getYVelocity(mVelocityTracker, i2) >= 0.0F) goto _L12; else goto _L11
_L11:
