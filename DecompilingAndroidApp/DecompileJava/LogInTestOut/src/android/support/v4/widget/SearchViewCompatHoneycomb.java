...
;
    ...
    {
        ((SearchView)view).setOnCloseListener((android.widget.SearchView.OnCloseListener)obj);
    }

    public static void setOnQueryTextListener(View view, Object obj)
    {
        ((SearchView)view).setOnQueryTextListener((android.widget.SearchView.OnQueryTextListener)obj);
    }
