...
class BundleCompatGingerbread
{
    ...
    public static IBinder getBinder(Bundle bundle, String s)
    {
        if(!sGetIBinderMethodFetched)
        {
            ...
            {
                Log.i("BundleCompatGingerbread", "Failed to retrieve getIBinder method", nosuchmethodexception);
            }
...
_L1:
        ...
        bundle;
_L4:
        Log.i("BundleCompatGingerbread", "Failed to invoke getIBinder via reflection", bundle);
...
_L3:
    ...
    public static void putBinder(Bundle bundle, String s, IBinder ibinder)
    {
        ...
        bundle;
_L2:
        Log.i("BundleCompatGingerbread", "Failed to invoke putIBinder via reflection", bundle);
